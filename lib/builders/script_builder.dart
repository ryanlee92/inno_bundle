...
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin"; ValueType: string; ValueName: ""; ValueData: "URL:${config.name} Protocol"; Flags: uninsdeletekey;
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin"; ValueType: string; ValueName: "URL Protocol"; ValueData: "";
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin\\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: """{app}\\${config.exeName}"",0";
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin\\shell\\open\\command"; ValueType: string; ValueName: ""; ValueData: """{app}\\${config.exeName}"" ""%1""";

Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin.slack"; ValueType: string; ValueName: ""; ValueData: "URL:${config.name} Protocol"; Flags: uninsdeletekey;
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin.slack"; ValueType: string; ValueName: "URL Protocol"; ValueData: "";
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin.slack\\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: """{app}\\${config.exeName}"",0";
Root: "HKCU"; Subkey: "Software\\Classes\\com.wavetogether.fillin.slack\\shell\\open\\command"; ValueType: string; ValueName: ""; ValueData: """{app}\\${config.exeName}"" ""%1""";
...
\n''';
  ...
  String _run() {
    return '''
[Run]
Filename: "{app}\\${config.exeName}"; Description: "{cm:LaunchProgram,{#StringChange('${config.name}', '&', '&&')}}"; Flags: nowait postinstall skipifsilent shellexec runasoriginaluser
\n''';
  }
